...
利用Go语言技术栈重构本人在实习期间参与的电商客服agent，在此过程中系统学习agent开发相关知识，拓展知识边界
...
**记得加上/chat/completion** （end point）

## 第二阶段 实现有上下文的对话

对话agent的上下文管理是开发者手动实现的，而非APIKEY供应商提供

开发者维护一个message【】列表，把这个列表给模型端，模型端就知道历史对话了